    ...
    LPARAM lParamSort)
{
	...
	case CData_mirrorDlg::Modified: {
		...
		case 0:
			...
			break;
		case 1:
			result = (entry1.NewSizeUI < entry2.NewSizeUI) ? -1 : (entry1.NewSizeUI == entry2.NewSizeUI) ? 0
			                                                                                             : 1;
			break;
		case 2:
			result = (entry1.OldSizeUI < entry2.OldSizeUI) ? -1 : (entry1.OldSizeUI == entry2.OldSizeUI) ? 0
			                                                                                             : 1;
			break;
		case 3:
