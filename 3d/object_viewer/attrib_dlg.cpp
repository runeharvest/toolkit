...
CAttribDlgFloat::CAttribDlgFloat(const std::string &valueID, CParticleWorkspace::CNode *node, float minRange, float maxRange)
    : CAttribDlgT<float>(valueID, node)
    , _MinRange(minRange)
    , _MaxRange(maxRange)
{
	_CstValueId = valueID;
...
CAttribDlgUInt::CAttribDlgUInt(const std::string &valueID, CParticleWorkspace::CNode *node, uint32 minRange, uint32 maxRange)
    : CAttribDlgT<uint32>(valueID, node)
    , _MinRange(minRange)
    , _MaxRange(maxRange)
{
	_CstValueId = valueID;
...
CAttribDlgInt::CAttribDlgInt(const std::string &valueID, CParticleWorkspace::CNode *node, sint32 minRange, sint32 maxRange)
    : CAttribDlgT<sint32>(valueID, node)
    , _MinRange(minRange)
    , _MaxRange(maxRange)
{
	_CstValueId = valueID;
...
//*************************************************************************************************************
CAttribDlgRGBA::CAttribDlgRGBA(const std::string &valueID, CParticleWorkspace::CNode *node)
...
//*************************************************************************************************************
CAttribDlgPlaneBasis::CAttribDlgPlaneBasis(const std::string &valueID, CParticleWorkspace::CNode *node)
...
CWnd *CAttribDlgPlaneBasis::editScheme(void)
{
	...
	if (dynamic_cast<NL3D::CPSPlaneBasisMemory *>(scheme))
	{
		...
		CValueFromEmitterDlgT<NL3D::CPlaneBasis> *vfe = new CValueFromEmitterDlgT<NL3D::CPlaneBasis>((NL3D::CPSPlaneBasisMemory *)(scheme),
		    ad,
		    this,
		    m_AttrBitmap.GetBitmap());
		vfe->init(this);
