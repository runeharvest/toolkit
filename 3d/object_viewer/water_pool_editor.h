...
protected:
	...
	struct CImpulsionStrenghtWrapper : IPSWrapperFloat
	{
		...
		{
			nlassert(Whm);
			Whm->setWaves(v, Whm->getWavePeriod(), Whm->getWaveImpulsionRadius(), Whm->getBorderWaves());
		}
		CImpulsionStrenghtWrapper()
		    : Whm(NULL)
		{
		}
