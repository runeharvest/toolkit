    ...
    float lumx3, float lumy3, uint8 nCol)
{
	...
	for (j = 0; j < nSizeY - 1; ++j)
		for (k = 0; k < nSizeX - 1; ++k)
		{
			...
			if (isInTriangle(k + 0.5, j + 0.5, lumx1, lumy1, lumx2, lumy2, lumx3, lumy3) || isInTriangle(k + 1.5, j + 0.5, lumx1, lumy1, lumx2, lumy2, lumx3, lumy3) || isInTriangle(k + 0.5, j + 1.5, lumx1, lumy1, lumx2, lumy2, lumx3, lumy3) || isInTriangle(k + 1.5, j + 1.5, lumx1, lumy1, lumx2, lumy2, lumx3, lumy3))
			{
