...
public:
	EPM_ExtrudeMouseProc(EditPatchMod *o, IObjParam *i)
	    : moveTrans(i)
	{
		po = o;
		ip = i;
...
public:
	EPM_BevelMouseProc(EditPatchMod *o, IObjParam *i)
	    : moveTrans(i)
	{
		po = o;
		ip = i;
...
public:
	...
	{
		if (localized) return GetString(IDS_TH_EDITPATCH);
		else return _T("NeL Patch Edit");
	}
#endif
...
class PickPatchAttach : public PickModeCallback,
